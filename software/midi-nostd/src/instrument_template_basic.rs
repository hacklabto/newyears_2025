    ...
    core: CoreAdsr<
        ...
        Filter<
            ...
            DoubleOscillator<
                P_FREQ,
                U_FREQ,
                CoreOscillator<P_FREQ, U_FREQ, OSC_0_PULSE_WIDTH, OSC_0_VOLUME, OSC_0_WAVE_FORM>,
                CoreOscillator<P_FREQ, U_FREQ, OSC_1_PULSE_WIDTH, OSC_1_VOLUME, OSC_1_WAVE_FORM>,
                OSC_1_SYNC_TO_0,
            >,
        >,
    >,
